...
//thinks to add if i have time include adding the price estimate that we're already getting from the endpoint, if/when I shou prices, follow ubers design guidelines,
